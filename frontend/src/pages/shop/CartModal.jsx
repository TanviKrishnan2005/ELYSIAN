...
const CartModal = ({ products, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* White cart panel */}
      <div
        className={`fixed top-0 right-0 h-full bg-white shadow-lg overflow-y-auto transform transition-transform duration-300 z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'} w-3/12 max-w-sm min-w-[450px]`}
      >
        {/* Header */}
